...
for(this_gene in all_genes){
  this_gene_file <- paste0("C:/STUDIES/RESEARCH/neural_ODE/all_manuscript_models/breast_cancer/inferred_influence_",
                           this_gene,".csv")
...
write.csv(all_harms_wide,
          "C:/STUDIES/RESEARCH/neural_ODE/all_manuscript_models/breast_cancer/all_inferred_influences_wide.csv",
          row.names = F,
          na = "")
