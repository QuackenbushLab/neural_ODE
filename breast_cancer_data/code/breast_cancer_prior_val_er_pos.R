...
long_val <- fread("C:/STUDIES/RESEARCH/neural_ODE/breast_cancer_data/clean_data/otter_chip_val_clean_er_pos.csv")
long_val[, val_pred := 1]
...
all_num_genes <- c(500, 1000, 2000, 4000)
#all_num_genes <- c(500)
for (num_genes in all_num_genes){
  ...
  #high_var_genes <- fread(paste0("C:/STUDIES/RESEARCH/neural_ODE/breast_cancer_data/clean_data/desmedt_gene_names_erpos_",num_genes,".csv"))$gene
