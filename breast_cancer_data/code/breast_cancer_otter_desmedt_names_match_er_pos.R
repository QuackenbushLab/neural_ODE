...
desmedt_gene_names <- fread("C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/Breast cancer-ER subtypes/er=1/Gene_names.csv",
                            header = T)
desmedt_gene_names[, num:= NULL]
setnames(desmedt_gene_names, "x", "V1")
...
write.csv(otter_tf_names, "C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/otter_tf_names_desmedt_conv_er_pos.csv",
          row.names = F)
...
write.csv(otter_gene_names, "C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/otter_gene_names_desmedt_conv_er_pos.csv",
          row.names = F)
