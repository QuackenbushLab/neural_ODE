...
### Read in name files
otter_gene_names <- fread("C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/otter_gene_names_desmedt_conv_er_pos.csv")
otter_tf_names <- fread("C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/otter_tf_names_desmedt_conv_er_pos.csv")
...
otter_val_chip[, c("gene", "V2","n_desm_names"):= NULL]

otter_val_chip <- unique(otter_val_chip)
write.csv(otter_val_chip, "C:/STUDIES/RESEARCH/neural_ODE/breast_cancer_data/clean_data/otter_chip_val_er_pos_clean.csv",
          row.names = F)
...
write.csv(otter_motif_prior, "C:/STUDIES/RESEARCH/ODE_project_local_old/breast_cancer_data/otter_clean_harmonized_full_prior_er_pos.csv",
          row.names = F)
