...
def decode_chromosome(individual, const_reg, num_var_reg, data, data_dim, curr_dim):
...
if __name__ == "__main__":
    ...
    for curr_dim in [3]:#range(data_dim):
        error = np.infty
        num_gen = 1
        # Init population
