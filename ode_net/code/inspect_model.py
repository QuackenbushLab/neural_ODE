...
prods_model = torch.load('C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/output/_pretrained_best_model/best_val_model_prods.pt')
alpha_comb = torch.load('C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/output/_pretrained_best_model/best_val_model_alpha_comb.pt')
...
np.savetxt("C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/model_inspect/wo_sums.csv", Wo_sums, delimiter=",")
np.savetxt("C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/model_inspect/bo_sums.csv", Bo_sums, delimiter=",")
np.savetxt("C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/model_inspect/wo_prods.csv", Wo_prods, delimiter=",")
np.savetxt("C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/model_inspect/bo_prods.csv", Bo_prods, delimiter=",")
np.savetxt("C:/STUDIES/RESEARCH/neural_ODE/ode_net/code/model_inspect/alpha_comb.csv", alpha_comb, delimiter=",")
