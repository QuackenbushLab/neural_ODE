...
clean_name = "rIFNbeta_70genes_53samples"
...
parser.add_argument('--data', type=str, default='/home/ubuntu/neural_ODE/rIFNbeta_data/clean_data/{}.csv'.format(clean_name))
...
#       opt = optim.Adam(odenet.parameters(), lr=settings['init_lr'], weight_decay=settings['weight_decay'])
        ...
        opt = optim.Adam([
                ...
                {'params': odenet.gene_multipliers,'lr': 1*settings['init_lr'], 'weight_decay': 0}
