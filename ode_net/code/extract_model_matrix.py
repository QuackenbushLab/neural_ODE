...
sums_model = torch.load('/home/ubuntu/neural_ODE/ode_net/code/output/_pretrained_best_model/trained_model_epoch_30_sums.pt')
prods_model = torch.load('/home/ubuntu/neural_ODE/ode_net/code/output/_pretrained_best_model/trained_model_epoch_30_prods.pt')
alpha_comb = torch.load('/home/ubuntu/neural_ODE/ode_net/code/output/_pretrained_best_model/trained_model_epoch_30_alpha_comb.pt')
gene_mult = torch.load('/home/ubuntu/neural_ODE/ode_net/code/output/_pretrained_best_model/trained_model_epoch_30_gene_multipliers.pt')
