...
setGeneric(
  ...
  def = function(simulation, numsamples, cor.strength, externalInputs, timeStamps) {
...
setMethod(
  f = 'simulateDataset',
  signature = c('SimulationGRN', 'numeric', 'missing', 'missing','missing'),
  definition = simDataset
)

setMethod(
  f = 'simulateDataset',
  signature = c('SimulationGRN', 'numeric', 'numeric', 'missing','numeric'),
  definition = simDataset
)
