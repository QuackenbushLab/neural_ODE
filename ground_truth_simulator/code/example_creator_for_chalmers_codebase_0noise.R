...
minTFs = 20 #minimum number of TFs enforced on sampled networks
...
write.table( datamat,
             "C:/STUDIES/RESEARCH/neural_ODE/ground_truth_simulator/clean_data/chalmers_350genes_300samples_earlyT_0noise_0bimod_0pt1initvar.csv", 
             sep=",",
             row.names = FALSE,
             col.names = FALSE,
             na = "")
